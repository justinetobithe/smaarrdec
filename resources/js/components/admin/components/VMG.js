...
export default function VMG() {
    ...
    const [vmgDetails, setVmgDetails] = useState({})
    ...
    const {
        ...
        defaultValues: {
            vision_mission_goal: vmgDetails.vision_mission_goal
        }
    });
    ...
    useEffect(() => {
        for (const property in vmgDetails) {
            setValue(property, vmgDetails[property])
        }
    }, [vmgDetails])
    ...
    useEffect(() => {
        ...
        if (response.error.legth || response.data !== null) {
            ...
            if (response.data.status) {
                history.push("/admin/page/vision-mission-and-goal");
            }
        }
    }, [response]);
    ...
    const onSubmit = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let fd = new FormData();
                fd.append("vmg", editorRef.current.getContent());
    ...
    return (
        <>
            <div className="container-fluid px-4">
                <h1 className="mt-4">Edit Vision, Mission, and Goal</h1>
                <ol className="breadcrumb mb-4">
                    <li className="breadcrumb-item"><NavLink to="/admin/dashboard">Dashboard</NavLink></li>
                    <li className="breadcrumb-item active">Edit Vision, Mission, and Goal</li>
                </ol>
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="mb-3 row-fluid">
                                                    ...
                                                    <Editor
                                                        ...
                                                        initialValue={
                                                            isset(vmgDetails.vision_mission_goal)
                                                                ? vmgDetails.vision_mission_goal
                                                                : data.vision_mission_goal
                                                        }
                                                        init={{
                                                            height: 500,
