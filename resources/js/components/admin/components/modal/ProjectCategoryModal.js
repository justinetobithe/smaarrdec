...
export default function ProjectCategoryModal() {
    ...
    const [response, handleHttpRequest] = useHttpRequest((data) => ({
        url: `api/project/category/update-status`,
        method: "POST",
        data,
    ...
    const [deleteResponse, handleDeleteRequest] = useHttpRequest((data) => ({
        url: "/api/project-categories/" + data,
        method: "DELETE",
        data,
        header: { "Content-type": "application/json" }
    }))
    ...
    const onSubmit = (formData) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fd.append("project_category_description", formData.project_category_description);
            ...
            <form>
                <div className="mb-3">
                    ...
                    <textarea
                        ...
                        defaultValue={state.modal.data.project_category_name}
                        rows="2"
                        disabled
                    ></textarea>
                </div>
                <div className="mb-3">
                    ...
                    <textarea
                        className="form-control"
                        rows="3"
                        defaultValue={state.modal.data.project_category_description}
                        {...register("project_category_description")}
                    ></textarea>
                </div>
                <div className="mb-3">
                    <label htmlFor="" className="col-form-label">
