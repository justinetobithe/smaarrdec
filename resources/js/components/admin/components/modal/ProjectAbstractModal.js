...
export default function ProjectAbstractModal() {
    ...
    const [response, handleHttpRequest] = useHttpRequest((data) => ({
        url: "/api/project/abstract/update-status",
        method: "POST",
        data,
    ...
    const onSubmit = (data) => {
        Swal.fire({
            title: "Are you sure you want to update this abstract?",
            icon: "info",
            ...
            if (result.isConfirmed) {
                let fd = new FormData();
                fd.append("report_id", state.modal.data.id);
            ...
            <form>
                <div className="mb-3">
                    ...
                    <input
                        ...
                        defaultValue={state.modal.data.abstract_name}
                        disabled
                    />
                </div>
                <div className="mb-3">
